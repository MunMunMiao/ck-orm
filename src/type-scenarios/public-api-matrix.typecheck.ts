...
const ckTypeNameMatrix = {
  ...
  enum8: [ckType.enum8({ open: 1, closed: 2 }), ckType.enum8("status_8", { open: 1, closed: 2 })],
  enum16: [ckType.enum16({ small: 1, large: 1000 }), ckType.enum16("status_16", { small: 1, large: 1000 })],
...
const columnTypeMatrix = {
  ...
  enum8: ckType.enum8({ open: 1, closed: 2 }),
  enum16: ckType.enum16({ small: 1, large: 1000 }),
...
const functionTypeMatrix = {
  ...
  abs: fn.abs<number>(activityLedger.actor_id),
  argMax: fn.argMax<string>(activityLedger.system_id, activityLedger.actor_id),
  argMin: fn.argMin<number>(activityLedger.actor_id, activityLedger.actor_id),
  ...
  greatest: fn.greatest<number>(activityLedger.actor_id, 0),
  ...
  if: fn.if<number>(ck.eq(activityLedger.event_phase, 1), activityLedger.actor_id, 0),
  indexOf: fn.indexOf(["vip"], "vip"),
  indexOfAssumeSorted: fn.indexOfAssumeSorted(["pro", "vip"], "vip"),
  intDiv: fn.intDiv<number>(activityLedger.actor_id, 60),
  intDivOrZero: fn.intDivOrZero<number>(activityLedger.actor_id, 60),
  ...
  divide: fn.divide(activityLedger.actor_id, 2),
  ...
  least: fn.least<number>(activityLedger.actor_id, 0),
  length: fn.length(["vip"]),
  max: fn.max<string>(activityLedger.system_id),
  min: fn.min<number>(activityLedger.actor_id),
  minus: fn.minus<number>(activityLedger.actor_id, 1),
  modulo: fn.modulo<number>(activityLedger.actor_id, 7),
  moduloOrZero: fn.moduloOrZero<number>(activityLedger.actor_id, 7),
  multiIf: fn.multiIf<number>(ck.eq(activityLedger.event_phase, 1), activityLedger.actor_id, 0),
  multiply: fn.multiply<number>(activityLedger.actor_id, 2),
  negate: fn.negate<number>(activityLedger.actor_id),
  not: fn.not(ck.eq(activityLedger.event_phase, 1)),
  notEmpty: fn.notEmpty(["vip"]),
  nullIf: fn.nullIf<number>(activityLedger.actor_id, 0),
  plus: fn.plus<number>(activityLedger.actor_id, 1),
  positionCaseInsensitive: fn.positionCaseInsensitive(activityLedger.system_id, "vip"),
  positionCaseInsensitiveUTF8: fn.positionCaseInsensitiveUTF8(activityLedger.system_id, "vip"),
  range: fn.range(1, 5),
