...
export const webEvents = chTable(
  "web_events",
  {
    ...
    viewed_at: chType.dateTime64(3),
    revenue: chType.decimal(18, 2),
...
export const rewardEvents = chTable(
  "reward_events",
  {
    ...
    created_at: chType.dateTime64(3),
    _peerdb_synced_at: chType.dateTime64(3),
...
export const tradeFills = chTable(
  "trade_fills",
  {
    ...
    filled_at: chType.dateTime64(3),
    quantity: chType.decimal(18, 2),
  },
  (table) => ({
    engine: "MergeTree",
...
export const quoteSnapshots = chTable(
  ...
  {
    symbol: chType.lowCardinality(chType.string()),
    quote_time: chType.dateTime64(3),
    bid: chType.decimal(18, 5),
  },
  (table) => ({
    engine: "MergeTree",
...
export const userDailySummary = chTable(
  "user_daily_summary",
  {
    ...
    total_revenue: chType.decimal(18, 2),
  },
  (table) => ({
    engine: "MergeTree",
...
export const schemaPrimitives = chTable(
  "schema_primitives",
  {
    ...
    fixed_string_value: chType.fixedString(4),
    decimal_value: chType.decimal(18, 2),
    date_value: chType.date(),
    date32_value: chType.date32(),
    time_value: chType.time(),
    time64_value: chType.time64(3),
    date_time_value: chType.dateTime(),
    date_time64_value: chType.dateTime64(3),
    ...
    qbit_value: chType.qbit(chType.float32(), 8),
