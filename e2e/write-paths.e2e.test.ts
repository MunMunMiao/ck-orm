    ...
    await db.runInSession(async (session) => {
      ...
      await session.insertJsonEachRow(scope, [
        {
          ...
          nullable_note: null,
          tags: ["first", null],
          signed_ids: ["-9223372036854775000"],
          unsigned_ids: ["18446744073709551000"],
          scores: { gold: 3 },
          pair: ["one", 11],
        },
        {
          ...
          tags: [],
          signed_ids: ["9223372036854775000"],
          unsigned_ids: ["18446744073709551001"],
          scores: {},
          pair: ["two", 22],
        },
      ]);
      ...
      const rows = await session
        .select({
          ...
          tags: scope.tags,
          signedIds: scope.signed_ids,
          unsignedIds: scope.unsigned_ids,
          scores: scope.scores,
          pair: scope.pair,
      ...
      expect(rows).toEqual([
        {
          ...
          nullableNote: null,
          tags: ["first", null],
          signedIds: ["-9223372036854775000"],
          unsignedIds: ["18446744073709551000"],
          scores: { gold: 3 },
          pair: ["one", 11],
          doubled: 2,
          label: "id=1",
        },
        {
          ...
          tags: [],
          signedIds: ["9223372036854775000"],
          unsignedIds: ["18446744073709551001"],
          scores: {},
          pair: ["two", 22],
          doubled: 4,
          label: "id=2",
